...
This command reads pending recommendations generated by \`harness-evolve scan\` or background analysis hooks. It presents each recommendation for your decision. You can filter by confidence level using arguments.
