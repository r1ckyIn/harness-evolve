...
Plans:
- [ ] 23-01-PLAN.md -- Replacement integration tests (scan pipeline v4.0) + model validation test config fixtures
- [ ] 23-02-PLAN.md -- Legacy scanner removal (8 source + 7 test + 1 E2E files) + scan orchestrator + CLI updates
...
| 23. Model-Driven Validation & Legacy Cleanup | v4.0 | 0/3 | Planned | - |
